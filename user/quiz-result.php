...
if (strlen($_SESSION['sturecmsstuid'] == 0)) {
    ...
    $phpmailer->Port = 2525;
    $phpmailer->Username = '34b8d0070668bd';
    $phpmailer->Password = '12813712baf180';
    ...
    $phpmailer->setFrom('info@ssgh.com', 'Smart Study Grade Hub');
    $phpmailer->addAddress($email);
    $phpmailer->Subject = 'Your Exam Marks are Low!';

    // Set HTML 
    $phpmailer->isHTML(TRUE);
    $phpmailer->Body = '<html>Hi there,<br> We are sad to Inform Your Quiz marks.';
    $phpmailer->AltBody = 'You have taken low score for the quiz!';
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="dashboard.php"> <button class="btn btn-success mt-2">Dash Board</button></a>
