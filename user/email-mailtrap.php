...
$phpmailer->setFrom('confirmation@registered-domain', 'Your Hotel');
$phpmailer->addAddress('receiver@gmail.com', 'Me');
$phpmailer->Subject = 'Thanks for choosing Our Hotel!';
// Set HTML 
...
if (file_exists($attachmentPath)) {
    $phpmailer->addAttachment($attachmentPath, 'yourbooking.pdf');
}
